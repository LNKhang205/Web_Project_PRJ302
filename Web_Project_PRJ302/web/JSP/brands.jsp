...
<html lang="vi">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            const buttons = document.querySelectorAll(".country-filter-btn");
            ...
            <div class="container">
                <nav class="nav">
                    ...
                    <ul class="nav-menu" id="navMenu">
                        ...
                        <li><a href="${pageContext.request.contextPath}/JSP/brands.jsp" class="nav-link active">Hãng xe</a></li>
                        ...
                        <a href="${pageContext.request.contextPath}/JSP/login.jsp" class="nav-link"></i> Đăng nhập</a></li>
                    </ul>
                ...
                <div class="brands-grid" id="brandsGrid">
                    ...
                    <div class="brand-card" data-country="Germany">
                        ...
                        <div class="brand-card-body">
                            ...
                            <div class="brand-actions">
                                <a href="${pageContext.request.contextPath}/JSP/cars.jsp?brand=mercedes" class="btn btn-primary btn-brand">
                    ...
                    <div class="brand-card" data-country="Germany">
                        ...
                        <div class="brand-card-body">
                            ...
                            <div class="brand-actions">
                                <a href="${pageContext.request.contextPath}/JSP/cars.jsp?brand=bmw" class="btn btn-primary btn-brand">
                                    <i class="fas fa-car"></i> Xem xe
                                </a>
                                <a href="#" class="btn btn-outline btn-brand">
                                    <i class="fas fa-info-circle"></i> Chi tiết
                    ...
                    <div class="brand-card" data-country="Germany">
                        ...
                        <div class="brand-card-body">
                            ...
                            <div class="brand-actions">
                                <a href="${pageContext.request.contextPath}/JSP/cars.jsp?brand=audi" class="btn btn-primary btn-brand">
                                    <i class="fas fa-car"></i> Xem xe
                                </a>
                                <a href="#" class="btn btn-outline btn-brand">
                                    <i class="fas fa-info-circle"></i> Chi tiết
                    ...
                    <div class="brand-card" data-country="Italy">
                        ...
                        <div class="brand-card-body">
                            ...
                            <div class="brand-actions">
                                <a href="${pageContext.request.contextPath}/JSP/cars.jsp?brand=lamborghini" class="btn btn-primary btn-brand">
                                    <i class="fas fa-car"></i> Xem xe
                                </a>
                                <a href="#" class="btn btn-outline btn-brand">
                                    <i class="fas fa-info-circle"></i> Chi tiết
                    ...
                    <div class="brand-card" data-country="United Kingdom">
                        ...
                        <div class="brand-card-body">
                            ...
                            <div class="brand-actions">
                                <a href="${pageContext.request.contextPath}/JSP/cars.jsp?brand=rollsroyce" class="btn btn-primary btn-brand">
                                    <i class="fas fa-car"></i> Xem xe
                                </a>
                                <a href="#" class="btn btn-outline btn-brand">
                                    <i class="fas fa-info-circle"></i> Chi tiết
                    ...
                    <div class="brand-card" data-country="Germany">
                        ...
                        <div class="brand-card-body">
                            ...
                            <div class="brand-actions">
                                <a href="${pageContext.request.contextPath}/JSP/cars.jsp?brand=porsche" class="btn btn-primary btn-brand">
                                    <i class="fas fa-car"></i> Xem xe
                                </a>
                                <a href="#" class="btn btn-outline btn-brand">
                                    <i class="fas fa-info-circle"></i> Chi tiết
                    ...
                    <div class="brand-card" data-country="Italy">
                        ...
                        <div class="brand-card-body">
                            ...
                            <div class="brand-actions">
                                <a href="${pageContext.request.contextPath}/JSP/cars.jsp?brand=ferrari" class="btn btn-primary btn-brand">
                                    <i class="fas fa-car"></i> Xem xe
                                </a>
                                <a href="#" class="btn btn-outline btn-brand">
                                    <i class="fas fa-info-circle"></i> Chi tiết
                    ...
                    <div class="brand-card" data-country="United Kingdom">
                        ...
                        <div class="brand-card-body">
                            ...
                            <div class="brand-actions">
                                <a href="${pageContext.request.contextPath}/JSP/cars.jsp?brand=bentley" class="btn btn-primary btn-brand">
                                    <i class="fas fa-car"></i> Xem xe
                                </a>
                                <a href="#" class="btn btn-outline btn-brand">
                                    <i class="fas fa-info-circle"></i> Chi tiết
                    ...
                    <div class="brand-card" data-country="Japan">
                        ...
                        <div class="brand-card-body">
                            ...
                            <div class="brand-actions">
                                <a href="${pageContext.request.contextPath}/JSP/cars.jsp?brand=lexus" class="btn btn-primary btn-brand">
                                    <i class="fas fa-car"></i> Xem xe
                                </a>
                                <a href="#" class="btn btn-outline btn-brand">
                                    <i class="fas fa-info-circle"></i> Chi tiết
