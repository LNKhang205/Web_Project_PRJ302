            ...
            <div class="container">
                <nav class="nav">
                    ...
                    <ul class="nav-menu" id="navMenu">
                        <li><a href="${pageContext.request.contextPath}/JSP/index.jsp" class="nav-link active">Trang chủ</a></li>
                        <li><a href="${pageContext.request.contextPath}/JSP/cars.jsp" class="nav-link">Xe bán</a></li>
            ...
            <div class="container">
                <div class="hero-content">
                    ...
                    <div class="hero-buttons">
                        <a href="${pageContext.request.contextPath}/JSP/cars.jsp" class="btn btn-primary">Xem bộ sưu tập</a>
        ...
        <section class="section" id="featured">
            <div class="container">
                ...
                <div class="car-grid">
                    ...
                    <div class="car-card">
                        <div class="car-card-image">
                            <img src="https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8?w=600" alt="Mercedes S-Class">
                            <span class="car-badge">Mới về</span>
                        </div>
                        <div class="car-card-content">
                            <div class="car-brand">Mercedes-Benz</div>
                            <h3 class="car-name">S-Class 2024</h3>
                            <div class="car-specs">
                                <div class="car-spec">
                            ...
                            <div class="car-footer">
                                <div class="car-price">
                                    5.5 tỷ <span>VNĐ</span>
                                </div>
                                <a href="${pageContext.request.contextPath}/JSP/car-detail.jsp?id=1" class="btn btn-primary btn-view">Xem chi tiết</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="car-card">
                        <div class="car-card-image">
                            <img src="https://images.unsplash.com/photo-1555215695-3004980ad54e?w=600" alt="BMW 7 Series">
                        ...
                        <div class="car-card-content">
                            ...
                            <div class="car-footer">
                                <div class="car-price">
                                    6.2 tỷ <span>VNĐ</span>
                                </div>
                                <a href="${pageContext.request.contextPath}/JSP/car-detail.jsp?id=5" class="btn btn-primary btn-view">Xem chi tiết</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="car-card">
                        <div class="car-card-image">
                            <img src="https://images.unsplash.com/photo-1606664515524-ed2f786a0bd6?w=600" alt="Lamborghini">
                            <span class="car-badge">Siêu xe</span>
                        </div>
                        <div class="car-card-content">
                            ...
                            <div class="car-footer">
                                ...
                                <a href="${pageContext.request.contextPath}/JSP/car-detail.jsp?id=9" class="btn btn-primary btn-view">Xem chi tiết</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="car-card">
                        <div class="car-card-image">
                            <img src="https://images.unsplash.com/photo-1617531653520-bd466ee429b1?w=600" alt="Audi A8">
                        ...
                        <div class="car-card-content">
                            ...
                            <div class="car-footer">
                                <div class="car-price">
                                    5.8 tỷ <span>VNĐ</span>
                                </div>
                                <a href="${pageContext.request.contextPath}/JSP/car-detail.jsp?id=7" class="btn btn-primary btn-view">Xem chi tiết</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="car-card">
                        <div class="car-card-image">
                            <img src="https://images.unsplash.com/photo-1621135802920-133df287f89c?w=600" alt="Rolls-Royce">
                            <span class="car-badge">Độc quyền</span>
                        </div>
                        <div class="car-card-content">
                            <div class="car-brand">Rolls-Royce</div>
                            <h3 class="car-name">Phantom Extended</h3>
                            <div class="car-specs">
                                <div class="car-spec">
                                    <i class="fas fa-tachometer-alt"></i>
                                    <span>0 km</span>
                            ...
                            <div class="car-footer">
                                ...
                                <a href="${pageContext.request.contextPath}/JSP/car-detail.jsp?id=10" class="btn btn-primary btn-view">Xem chi tiết</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="car-card">
                        <div class="car-card-image">
                            <img src="https://images.unsplash.com/photo-1614200187524-dc4b892acf16?w=600" alt="Porsche 911">
                        ...
                        <div class="car-card-content">
                            ...
                            <div class="car-footer">
                                ...
                                <a href="${pageContext.request.contextPath}/JSP/car-detail.jsp?id=11" class="btn btn-primary btn-view">Xem chi tiết</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div style="text-align: center; margin-top: 3rem;">
                    <a href="${pageContext.request.contextPath}/JSP/cars.jsp" class="btn btn-outline">Xem tất cả xe</a>
                </div>
            </div>
        </section>
